...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Instrumenten\Multiparameter\Multiparameter_Aquatroll\S7472 V1_00 Aquatroll meting max 4 stuks.CR300"
