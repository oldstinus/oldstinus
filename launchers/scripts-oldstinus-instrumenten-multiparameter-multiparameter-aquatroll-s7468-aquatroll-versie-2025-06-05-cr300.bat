...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Instrumenten\Multiparameter\Multiparameter_Aquatroll\S7468_Aquatroll_versie_2025_06_05.CR300"
