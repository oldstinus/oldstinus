...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Instrumenten\Multiparameter\Multiparameter_Aquatroll\Ai-programma1-OK.cr300"
