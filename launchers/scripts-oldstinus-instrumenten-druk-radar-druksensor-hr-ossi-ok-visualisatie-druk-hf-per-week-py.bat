...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Instrumenten\Druk-radar\Druksensor_HR_OSSI\OK_visualisatie_druk_HF_per_week.py"
