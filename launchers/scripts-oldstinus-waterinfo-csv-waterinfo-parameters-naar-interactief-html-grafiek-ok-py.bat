...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\WATERINFO\CSV-waterinfo_parameters_naar_interactief_html_grafiek-OK.py"
