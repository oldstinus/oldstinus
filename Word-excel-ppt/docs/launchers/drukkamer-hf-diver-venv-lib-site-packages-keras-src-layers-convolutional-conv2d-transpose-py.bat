...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\keras\src\layers\convolutional\conv2d_transpose.py"
