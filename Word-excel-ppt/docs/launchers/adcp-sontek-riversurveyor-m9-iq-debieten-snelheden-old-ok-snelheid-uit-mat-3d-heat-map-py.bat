...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Sontek_Riversurveyor_M9_IQ\Debieten&snelheden\Old\OK_Snelheid_uit_MAT_3d_heat-map.py"
