...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Multiparameter_YSI\DAT naar csv\env\Lib\site-packages\_plotly_future_\v4.py"
