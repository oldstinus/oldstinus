...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\_pyinstaller_hooks_contrib\stdhooks\hook-google.cloud.kms_v1.py"
