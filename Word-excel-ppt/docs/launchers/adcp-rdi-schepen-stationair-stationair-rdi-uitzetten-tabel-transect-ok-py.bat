@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_RDI_schepen_stationair\Stationair"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_RDI_schepen_stationair\Stationair\RDI_uitzetten_tabel_transect-OK.py"
