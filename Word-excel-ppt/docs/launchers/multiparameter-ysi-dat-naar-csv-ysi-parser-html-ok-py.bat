@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Multiparameter_YSI\DAT naar csv"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Multiparameter_YSI\DAT naar csv\YSI-parser_html_OK.py"
