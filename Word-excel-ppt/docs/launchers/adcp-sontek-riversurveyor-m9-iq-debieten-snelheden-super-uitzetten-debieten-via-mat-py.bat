...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Sontek_Riversurveyor_M9_IQ\Debieten&snelheden\Super_uitzetten debieten-via mat.py"
