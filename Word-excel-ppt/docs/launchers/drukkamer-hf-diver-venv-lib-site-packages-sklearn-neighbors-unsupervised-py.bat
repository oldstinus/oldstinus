@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\sklearn\neighbors"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\sklearn\neighbors\_unsupervised.py"
