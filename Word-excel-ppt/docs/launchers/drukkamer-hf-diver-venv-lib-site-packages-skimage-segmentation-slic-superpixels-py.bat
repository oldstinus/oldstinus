@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\skimage\segmentation"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\venv\Lib\site-packages\skimage\segmentation\slic_superpixels.py"
