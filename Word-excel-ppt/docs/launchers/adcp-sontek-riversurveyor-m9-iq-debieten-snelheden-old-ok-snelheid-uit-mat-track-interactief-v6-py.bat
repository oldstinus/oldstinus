...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Sontek_Riversurveyor_M9_IQ\Debieten&snelheden\Old\OK-Snelheid_uit_MAT_track_interactief_v6.py"
