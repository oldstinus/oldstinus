...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Drukkamer_HF_DIVER\old\seven-segment-ocr-1\oldstinus\real-time_ysi-Kortrijk_OK.py"
