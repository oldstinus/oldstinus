...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Sontek_Riversurveyor_M9_IQ\Debieten&snelheden\SUPER_M9_S5_MAT_multi_3D_parallel_tijdtracks_gui_HTML.py"
