...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Nortek_Aquadopp_AWAC_Vector\Instrumenten\Vector\old\combi_vector_AWAC-ok1.py"
