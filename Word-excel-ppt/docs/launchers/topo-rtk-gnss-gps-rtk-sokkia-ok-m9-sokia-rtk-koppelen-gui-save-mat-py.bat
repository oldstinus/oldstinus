@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\TOPO-RTK_GNSS-GPS\RTK_Sokkia"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\TOPO-RTK_GNSS-GPS\RTK_Sokkia\OK_M9_Sokia_rtk_koppelen_gui_save_mat.py"
