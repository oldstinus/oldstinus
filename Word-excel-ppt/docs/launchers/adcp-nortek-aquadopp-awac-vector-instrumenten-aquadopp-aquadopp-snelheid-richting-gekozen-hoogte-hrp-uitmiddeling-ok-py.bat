...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Nortek_Aquadopp_AWAC_Vector\Instrumenten\Aquadopp\Aquadopp_snelheid_richting_gekozen_hoogte_HRP_uitmiddeling-OK.py"
