...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Multiparameter_Aquatroll\S7472 V1_01 Aquatroll meting_automatisch.CR300"
