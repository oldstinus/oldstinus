...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Sontek_Riversurveyor_M9_IQ\GNSS_RTK_koppelen_export\Super_M9_MAT_Carlson_georef_1ref_punt_manual.py"
