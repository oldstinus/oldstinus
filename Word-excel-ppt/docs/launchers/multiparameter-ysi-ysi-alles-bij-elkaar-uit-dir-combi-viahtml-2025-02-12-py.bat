...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\Multiparameter_YSI\YSI alles bij elkaar uit dir\combi_viahtml_2025_02_12.py"
