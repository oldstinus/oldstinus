...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Nortek_Aquadopp_AWAC_Vector\Instrumenten\Aquadopp\Super_tijdrange-rose_lopend_gemiddelde_aquadopp.py"
