...
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\ADCP_Nortek_Aquadopp_AWAC_Vector\Instrumenten\AWAC\combi_awac-vector_plusmin_2025_03_05_OK.py"
