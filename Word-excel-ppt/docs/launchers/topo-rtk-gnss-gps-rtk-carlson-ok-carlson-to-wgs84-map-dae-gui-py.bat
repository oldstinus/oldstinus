@echo off
setlocal
set "PROJECT_DIR=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\TOPO-RTK_GNSS-GPS\RTK_Carlson"
set "SCRIPT_PATH=C:\Users\claeysst\AppData\Roaming\Python\Python312\Scripts\oldstinus\TOPO-RTK_GNSS-GPS\RTK_Carlson\OK-carlson_to_wgs84_map_dae_gui.py"
