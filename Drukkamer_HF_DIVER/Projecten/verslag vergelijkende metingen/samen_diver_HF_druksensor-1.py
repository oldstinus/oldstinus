...
# Functie om samengestelde grafiek te plotten (wave en mon samen) met tijdselectie
...
def get_time_range():
    ...
    start_time_str = simpledialog.askstring("Begin tijd", "Voer de begin tijd in (YYYY-MM-DD HH:MM:SS):")
    end_time_str = simpledialog.askstring("Eind tijd", "Voer de eind tijd in (YYYY-MM-DD HH:MM:SS):")
    ...
    try:
        ...
        messagebox.showerror("Fout", "Ongeldige tijdinvoer. Gebruik het juiste formaat: YYYY-MM-DD HH:MM:SS")
        return None, None
...
def main():
    ...
    if mon_file:
        ...
        if df_wave is not None:
            # Vraag de gebruiker om de tijdsperiode voor de gecombineerde grafiek
