...
def compute_boat_track(bottom_track, system):
    ...
    bottom_track : mat_struct
        Structure met veld ``BT_Vel`` (E,N,Up,Err) en ``BT_Depth``.
    system : mat_struct
