...
def compute_depth_mean_vectors(md: dict):
    ...
    bt_depth_raw = _as_float_1d(getattr(bottom_track, "BT_Depth", None))
    n_hint = int(bt_depth_raw.size) if bt_depth_raw.size > 0 else None
    ...
    bt_depth = _align_to_len(bt_depth_raw, n_ens)
